...
export function StatCard({ value, label }: StatCardProps) {
  return (
    <div className="relative flex flex-col gap-1 px-4 py-4 rounded-xl border border-border/10 hover:border-accent-blue duration-300 group">
      <h2 className="text-4xl text-foreground">{value}</h2>
