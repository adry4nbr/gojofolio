  ...
  return (
    <div className="size-full p-8 flex items-center justify-center">
      <div className="relative size-80 ">
        <motion.div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-100 rounded-full border-2 border-dashed border-spacing-6 border-accent-blue/50 shadow-[0_0_8px_1px] shadow-accent-blue/30"
          animate={{ rotate: 360 }}
