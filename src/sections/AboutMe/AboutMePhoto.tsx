...
export function AboutMePhoto() {
  return (
    <div className="size-full p-4 md:p-8 flex items-center justify-center">
      {/* Foto principal: reduzida para size-56 no mobile, md:size-80 original no desktop */}
      <div className="relative size-50 md:size-80 mt-6 md:mt-0">
        <motion.div
          // {/* Aro externo: size-72 no mobile, md:size-100 no desktop */}
        ...
        {/* Aro interno: size-64 no mobile, md:size-90 no desktop */}
        ...
        <img
          src="/aboutMe/wallpapersden.com_satoru-gojo-manga-jujutsu-kaisen_2563x1355.jpg"
          alt="Minha Foto"
          className="absolute inset-0 size-full rounded-full object-cover border-4 border-border"
        />

        {/* Ajuste do distanciamento das Orbs para bater com o novo tamanho */}
