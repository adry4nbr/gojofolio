...
export function ProjectCard({ project, variants, custom }: ProjectCardProps) {
  ...
  return (
    <motion.div
      variants={variants}
      custom={custom}
      // O efeito de pular para cima ao passar o mouse foi protegido com md:
    ...
    >
      ...
      <div className="relative overflow-hidden md:group-hover:scale-105 transition-all duration-700">
        <img
          ...
          // Altura reduzida para h-56 no mobile
        ...
        >
          <a
            ...
            // Ícones ligeiramente menores no mobile (w-10 h-10)
          ...
          >
            {techs.map((tech) => (
              <motion.span
                ...
                // Ajuste no padding e tamanho da fonte das tags
